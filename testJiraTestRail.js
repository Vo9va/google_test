...
const { GoogleGenerativeAI } = require('@google/generative-ai');
  ...
  const TR_SECTION_ID = '127951';
  const TR_PROJECT_ID = '1';
...
async function generateTests() {
  ...
  console.log(`🔍 Fetching Main Jira issue: ${JIRA_DOMAIN}...`);
  console.log(`🔍 Fetching Main Jira issue: ${JIRA_EMAIL}...`);
  console.log(`🔍 Fetching Main Jira issue: ${JIRA_TOKEN}...`);
